...
export function TemplatesPage(){
  ...
  return <Page title="Client profile templates" eyebrow="Reusable content" actions={manage.data?<Button leadingIcon={<Plus size={14}/>} onClick={()=>{setCreating(true);setSelectedId(null)}}>New template</Button>:undefined}>
