...
export type CandidateProfileGeneration={profileVersionId:string;draft:CandidateProfileDraft;evaluation:{id:string;score:number;evidence:CandidateRequirementEvidence[]};requestId:string}
