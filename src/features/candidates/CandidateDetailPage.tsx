...
export function CandidateDetailPage(){
  ...
  return <Page title={candidate.full_name}
    ...
    {/* Invisible from this page (it doesn't render the candidates list itself), but without this the
      * Candidates list's Pipeline column would stay stale for whoever adds a candidate to a job from
      * here and then tabs back to the list -- the same gap the list's own call site had. */}
