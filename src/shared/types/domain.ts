...
export type Job = { id: string; organization_id: string; company_id: string; pipeline_id: string | null; title: string; location: string | null; priority: JobPriority; status: JobStatus; currency: string | null; placement_fee_percentage: number | null; owner_member_id:string|null; opened_at: string | null; updated_at: string; companies?: Pick<Company,'id'|'name'> | null }
...
export type Activity={id:string;activity_type:ActivityType;direction:'inbound'|'outbound'|'internal'|null;subject:string|null;summary:string;occurred_at:string;created_by:string;profiles?:{full_name?:string|null}|null}
