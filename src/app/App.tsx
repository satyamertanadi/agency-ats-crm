...
const PublicReferralPage=lazy(()=>import('../features/referrals/PublicReferralPage').then((module)=>({default:module.PublicReferralPage})))
const ReferralsPage=lazy(()=>import('../features/referrals/ReferralsPage').then((module)=>({default:module.ReferralsPage})))
...
export function App(){return <RouteErrorBoundary><Suspense fallback={<LoadingState label="Loading view…"/>}><Routes>
  <Route path="/login" element={<LoginPage/>}/><Route path="/signup" element={<SignupPage/>}/><Route path="/reset-password" element={<ResetPasswordPage/>}/><Route path="/onboarding" element={<OnboardingPage/>}/><Route path="/access-pending" element={<AccessPendingPage/>}/><Route path="/invite/:token" element={<InvitePage/>}/><Route path="/review/:token" element={<PublicReviewPage/>}/><Route path="/refer/:token" element={<PublicReferralPage/>}/>
  <Route element={<Protected/>}><Route path="/app" element={<WorkspaceIndex/>}/><Route path="/app/:organizationSlug"><Route index element={<WorkspaceHome/>}/><Route path="today" element={<TodayPage/>}/><Route path="candidates" element={<CandidatesPage/>}/><Route path="candidates/:candidateId" element={<CandidateDetailPage/>}/><Route path="referrals" element={<CapabilityRoute capability="canWriteCandidates"><ReferralsPage/></CapabilityRoute>}/><Route path="clients" element={<ClientsPage/>}/><Route path="scorecard" element={<ScorecardPage/>}/><Route path="clients/:companyId" element={<CompanyDetailPage/>}/><Route path="clients/:companyId/contacts/:contactId" element={<ContactDetailPage/>}/><Route path="jobs" element={<JobsPage/>}/><Route path="jobs/:jobId" element={<JobWorkspacePage/>}/><Route path="admin" element={<AdminCenterPage/>}/><Route path="admin/personal" element={<PersonalSettingsPage/>}/><Route path="admin/reports" element={<CapabilityRoute capability="canViewTeamReports"><ReportsPage/></CapabilityRoute>}/><Route path="admin/finance" element={<CapabilityRoute capability="canManageFinance"><PlacementsPage/></CapabilityRoute>}/><Route path="admin/imports" element={<CapabilityRoute capability="canImport"><ImportsPage/></CapabilityRoute>}/><Route path="admin/templates" element={<CapabilityRoute capability="canManageTemplates"><TemplatesPage/></CapabilityRoute>}/><Route path="admin/workspace" element={<CapabilityRoute capability="canManageWorkspace"><SettingsPage/></CapabilityRoute>}/><Route path="admin/pipeline" element={<CapabilityRoute capability="canManageWorkspace"><PipelineSettingsPage/></CapabilityRoute>}/>
  <Route path="dashboard" element={<LegacyRedirect area="today"/>}/><Route path="companies" element={<LegacyRedirect area="clients"/>}/><Route path="companies/:companyId" element={<LegacyRedirect area="clients"/>}/><Route path="contacts" element={<LegacyRedirect area="clients"/>}/><Route path="contacts/:contactId" element={<ContactDetailPage/>}/><Route path="jobs/:jobId/pipeline" element={<LegacyRedirect area="jobs"/>}/><Route path="submissions" element={<LegacyRedirect area="today"/>}/><Route path="delivery" element={<LegacyRedirect area="today"/>}/><Route path="tasks" element={<LegacyRedirect area="today"/>}/><Route path="search" element={<LegacyRedirect area="today"/>}/><Route path="placements" element={<LegacyRedirect area="admin/finance"/>}/><Route path="reports" element={<LegacyRedirect area="admin/reports"/>}/><Route path="imports" element={<LegacyRedirect area="admin/imports"/>}/><Route path="templates" element={<LegacyRedirect area="admin/templates"/>}/><Route path="settings" element={<LegacyRedirect area="admin/personal"/>}/></Route></Route>
