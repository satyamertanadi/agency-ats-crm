...
import { LoginPage,OnboardingPage,ResetPasswordPage,SignupPage } from '../features/auth/AuthPages'
...
export function App(){return <Suspense fallback={<LoadingState label="Loading view…"/>}><Routes>
  <Route path="/login" element={<LoginPage/>}/><Route path="/signup" element={<SignupPage/>}/><Route path="/reset-password" element={<ResetPasswordPage/>}/><Route path="/onboarding" element={<OnboardingPage/>}/><Route path="/invite/:token" element={<InvitePage/>}/><Route path="/review/:token" element={<PublicReviewPage/>}/>
  <Route element={<Protected/>}><Route path="/app" element={<WorkspaceIndex/>}/><Route path="/app/:organizationSlug"><Route index element={<Navigate to="dashboard" replace/>}/><Route path="dashboard" element={<DashboardPage/>}/><Route path="candidates" element={<CandidatesPage/>}/><Route path="companies" element={<CompaniesPage/>}/><Route path="contacts" element={<ContactsPage/>}/><Route path="jobs" element={<JobsPage/>}/><Route path="jobs/:jobId/pipeline" element={<PipelinePage/>}/><Route path="submissions" element={<SubmissionsPage/>}/><Route path="delivery" element={<DeliveryPage/>}/><Route path="placements" element={<PlacementsPage/>}/><Route path="tasks" element={<TasksPage/>}/><Route path="search" element={<SearchPage/>}/><Route path="reports" element={<ReportsPage/>}/><Route path="templates" element={<TemplatesPage/>}/><Route path="settings" element={<SettingsPage/>}/></Route></Route>
