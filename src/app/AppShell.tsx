...
import { BarChart3,BriefcaseBusiness,Building2,CalendarRange,CheckSquare,ChevronDown,ContactRound,FileUp,LayoutDashboard,LogOut,Menu,MonitorSmartphone,Moon,PanelLeftClose,Plus,Search,Send,Settings,SlidersHorizontal,Sun,UserPlus,UserRoundSearch,WalletCards,X } from 'lucide-react'
...
import {useRealtimeSync} from '../features/core/useRealtimeSync'
...
export function AppShell() {
  ...
  const [theme,setTheme]=useState<ThemePreference>(readPreference);const [mobileOpen,setMobileOpen]=useState(false);const [collapsed,setCollapsed]=useState(false);const [commandOpen,setCommandOpen]=useState(false);const [userMenuOpen,setUserMenuOpen]=useState(false);const [quickAddOpen,setQuickAddOpen]=useState(false)
