...
const functions=['calendar-auth-callback','calendar-auth-start','calendar-disconnect','calendar-sync','execute-import','generate-candidate-profile','generate-interview-rubric','ingest-interview-transcript','location-autocomplete','parse-candidate-cv','parse-linkedin-profile','public-review','scheduled-maintenance','send-invitation','send-submission']
