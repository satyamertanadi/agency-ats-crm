...
const functions=['ai-evaluate','calendar-auth-callback','calendar-auth-start','calendar-disconnect','calendar-sync','execute-import','generate-candidate-profile','parse-candidate-cv','public-review','refer','send-invitation','send-submission']
