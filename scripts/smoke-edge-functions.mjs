...
const functions=['ai-evaluate','calendar-auth-callback','calendar-auth-start','calendar-disconnect','calendar-sync','execute-import','parse-candidate-cv','public-review','send-invitation','send-submission']
